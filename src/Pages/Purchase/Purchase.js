...
const Purchase = () => {
  ...
  const handleForm = (event) => {
    ...
    console.log(order);
    fetch("https://compact-server-side.onrender.com/order", {
      method: "POST",
      headers: {
    ...
    <div className="flex-col justify-center my-20">
      ...
      <div className="w-3/5 py-20 lg:flex lg:justify-between lg:items-center border-2 rounded-md shadow-2xl shadow-purple-500 mx-auto px-10">
        ...
        <div className="my-auto mx-auto">
          ...
          <h1 className="text-lg font-medium">
            Minimum order quantity : {part.minimum_order}
          </h1>
          ...
          <div class="card-body">
            ...
            >
              ...
              <input
                type="submit"
                valaue="Submit"
                class="input input-bordered w-full max-w-xs bg-purple-600 text-white hover:bg-purple-800 font-bold text-xl"
              />
              {/* {quantityError}
                            {
