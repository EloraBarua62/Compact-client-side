    ...
    return (
        <div className='w-full bg-slate-100 py-10'>
            ...
            {/* <div className='grid grid-cols-1 md:grid-cols-2 gap-40'> */}
                <img src={person} alt="" className='max-w-lg h-96 rounded-lg mx-auto px-5'/>
                <div className='max-w-lg mx-auto px-5 pt-16'>
                    <p className='text-2xl font-medium pb-5'>I'm Richard.CEO of <span className='text-purple-600 font-bold'>COMPACT</span> .Working with all of my expert employee for many years.I'm here to know about your experience.Send us email,messages if you need us.</p>
