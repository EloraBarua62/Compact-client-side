...
const RatingReview = () => {
    ...
    const { data: ratings, isLoading } = useQuery('user_rating', () => fetch('https://shielded-castle-46219.herokuapp.com/ratings').then(res => res.json()))
    console.log(ratings);
                ...
                <div className='px-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10'>
                    {
                        ratings.map(rating => <div
                            class="card lg:max-w-lg bg-base-100 shadow-2xl shadow-purple-400 py-2">
